...
public class Config {
	...
	public static String SERVER_NAME = "DimeScape";
	...
	public static final String[] MODERATORS = {"Demension"};
    public static final String[] ADMINISTRATORS = {"cardyz","Typoerased"};
	public static final String[] OWNER = {"Banter","Matt123337"};
	public static final String[] DONATOR = {"Chris","Matt123337"};
