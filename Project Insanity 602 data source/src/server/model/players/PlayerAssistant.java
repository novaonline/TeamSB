...
public int backupItemsN[] = new int[Config.BANK_SIZE];
	...
	**/
	...
	public void openUpBank(){
		if(c.bankpin == 0 || c.pinset == 1) {
			...
			c.sendMessage("You did not enter your bankpin yet! ::enterpin");
			return;
		}
	}
	...
	**/
	...
	public void addStarter() {
		if (!Connection.hasRecieved1stStarter(Server.playerHandler.players[c.playerId].connectedFrom)) {
			c.getItems().addItem(995,1000000);
                	...
                	c.getItems().addItem(3843,1);
					c.getItems().addItem(2445,100);
                	c.getItems().addItem(380,500);
                	c.getItems().addItem(542,1);
                	c.getItems().addItem(544,1);
                	c.getItems().addItem(2903,1);
                	c.getItems().addItem(1333,1);
                	c.getItems().addItem(8008,10);
                	c.getItems().addItem(8009,10);
                	c.getItems().addItem(8010,10);
                	c.getItems().addItem(8011,10);
	...
	//Quest Tab
		c.getPA().sendFrame126("Beta Mode", 640);
		c.getPA().sendFrame126("@or1@Players: @gre@"+PlayerHandler.getPlayerCount(), 663);
	...
	public void writeCommandLog(String playerCommand) {
