...
public class ObjectManager {
    ...
    {
        //client.getPA().checkObjectSpawn(410, 3093, 3506, 2, 10);
		client.getPA().checkObjectSpawn(409, 2340, 9811, 2, 10);
        client.getPA().checkObjectSpawn(3044, 2388, 9811, 2, 10);
		client.getPA().checkObjectSpawn(409, 3096, 3506, 2, 10);
        client.getPA().checkObjectSpawn(3044, 2377, 9806, 2, 10);
		client.getPA().checkObjectSpawn(6552, 2335, 9811, 2, 10);
        ...
        client.getPA().checkObjectSpawn(6552, 3099, 3506, 2, 10);
		client.getPA().checkObjectSpawn(2213, 2333, 9814, 2, 10);
		client.getPA().checkObjectSpawn(2213, 2332, 9814, 2, 10);
		client.getPA().checkObjectSpawn(2213, 2331, 9814, 2, 10);
		client.getPA().checkObjectSpawn(6162, 3088, 3483, 2, 10);
		client.getPA().checkObjectSpawn(6163, 3086, 3483, 2, 10);
		client.getPA().checkObjectSpawn(6164, 3084, 3483, 2, 10);
